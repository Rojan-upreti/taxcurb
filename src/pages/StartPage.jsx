    ...
    <div className="min-h-screen bg-stone-50">
      ...
      <main className="max-w-6xl mx-auto px-4 md:px-8 py-16">
        <div className="max-w-3xl">
          <h1 className="text-4xl md:text-5xl font-semibold text-ink mb-6">Start Filing Your Taxes</h1>
          <p className="text-xl text-slate-700 mb-8 leading-relaxed">
            Let's get started with your tax return. We'll guide you through the process step by step.
          </p>
