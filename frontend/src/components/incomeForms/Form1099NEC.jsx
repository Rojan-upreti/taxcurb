...
function Form1099NEC({ data = {}, onChange, onValidationChange }) {
  ...
  return (
    <div className="space-y-4">
      ...
      <QuestionCard>
        <h3 className="text-sm font-semibold text-ink mb-4">Nonemployee Compensation Information</h3>
        <div className="space-y-4">
          <div><label className="block text-xs font-semibold text-ink mb-2">Box 1 - Nonemployee compensation</label><input type="text" value={formData.box1NonemployeeCompensation} onChange={(e) => handleChange('box1NonemployeeCompensation', formatCurrency(e.target.value))} placeholder="0.00" className="w-full px-4 py-2 text-sm border-2 border-slate-300 bg-white text-ink font-medium focus:outline-none focus:border-ink rounded-full" /></div>
